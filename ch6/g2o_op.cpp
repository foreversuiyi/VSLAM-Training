...
int main(int argc, char** argv)
{
	...
	//	g2o::OptimizationAlgorithmDogleg(std::move(solver_ptr));
	...
	chrono::duration<double> time_duration = chrono::duration_cast<
	chrono::duration<double> >(t2 - t1);
	cout << "Solve time cost = " << time_duration.count() << "seconds" << endl;
