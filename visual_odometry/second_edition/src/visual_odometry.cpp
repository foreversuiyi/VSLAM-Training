...
namespace myslam
{
	...
	new cv::flann::LshIndexParams(5, 10, 2))
  {
	...
	scale_ = Config::get<double> ("scale_factor");
	...
	map_point_erase_ratio_  = Config::get<double>("map_point_erase_ratio_");
	orb_ = cv::ORB::create(num_features_, scale_, level_pyramid_);
  }
  ...
  {
	boost::timer timer;
	//if(state_ == INITIALIZING){orb_ -> detect(curr_ -> color_, keypoints_ref_);}
  ...
  void VisualOdometry::featureMatching()
  {
	...
	//matcher_bf_.match(desp_map, descriptors_curr_, matches);
