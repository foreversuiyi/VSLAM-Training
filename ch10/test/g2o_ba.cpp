...
{   
    ...
    unique_ptr<g2o::LinearSolver<BalBlockSolver::PoseMatrixType>> ulinearSolver(linearSolver);

    unique_ptr<BalBlockSolver>solver_ptr(new BalBlockSolver(std::move(ulinearSolver)));
